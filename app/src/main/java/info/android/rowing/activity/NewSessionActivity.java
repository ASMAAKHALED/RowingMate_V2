...
public class NewSessionActivity extends AppCompatActivity implements LocationListener, SensorEventListener, IBaseGpsListener {
    ...
    private String time;
    private String username="asmaa ";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_new_session);

       // 88mDatabase=FirebaseDatabase.getInstance().getReference(); //,Gets the default FirebaseDatabase instance
        //88mMessageDatabaseReference=mFirebaseDatabase.getReference("server").child("strokeRate");
        //00mMessageDatabaseReference2=mFirebaseDatabase.getReference("server/speed");//.child("strokeRate");
       ...
       RowerData mRowerData=new RowerData( strRate,  nCurrentSpeed,  angle) ;
...
*/
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
              ...
              //mMessageDatabaseReference = ref.child("strokeRate");
             //usersRef2 = ref.child("speed");
                username="asmaa ";
                 RowerData mRowerData=new RowerData( username,strRate, 10,0,0,null) ;

                mMessageDatabaseReference.push().setValue(mRowerData); //---+-+-+-+

//what ever we want to send we can make a child  for it
                // usersRef.setValue(x);
               // ref.child("Rower data").setValue(mRowerData);  ///+++++++++++++++
             //88  mMessageDatabaseReference .push().setValue(mRowerData);
             /// // mMessageDatabaseReference.push().setValue(strRate);
               //00 mMessageDatabaseReference2.push().setValue(nCurrentSpeed);
                submitPost();
       ...
       /* mChildEventListener =new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //RowerData friendlyMessages=dataSnapshot.getValue(RowerData.class); // object


               // mMessageAdapter.add(friendlyMessages);
                // String asmaa=dataSnapshot.getValue(String.class);
...
/*
        ...
        mChildEventListener =new ChildEventListener(){
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
               // String cle = dataSnapshot.getKey();
                //String STR=dataSnapshot.child("strokeRate").getValue(String.class);
               String cle="yarab";
                TextView as = (TextView) findViewById(R.id.as1);
                as.setText(cle + "get key :)");

              //  TextView kh = (TextView) findViewById(R.id.as2);
               // kh.setText(String.valueOf(STR + "child :)"));

              String server = dataSnapshot.getKey();
                String child = dataSnapshot.child("strokeRate").getValue(String.class);
                String child2 = dataSnapshot.child("Speed").getValue(String.class);
               // TextView as = (TextView) findViewById(R.id.as1);
                //as.setText(String.valueOf(child + "stroke :)"));
                TextView kh = (TextView) findViewById(R.id.as2);
                kh.setText(String.valueOf(server + "server :)"));
        ...
        */
        //mMessageDatabaseReference.addChildEventListener(mChildEventListener); // to know any change happened
       // usersRef2.addChildEventListener(mChildEventListener); // to know any change happened
...
/*
     ...
     mMessageDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
              //  for (DataSnapshot StrokeRate : dataSnapshot.getChildren()) {

                  // String RX = StrokeRate.getValue(String.class);
                //double str = (double) dataSnapshot.getValue();
              //00 String str = dataSnapshot.getValue(String.class);
              //////////  String sp = dataSnapshot.child("speed").getValue(String.class);

                // RowerData mRowerData=dataSnapshot.getValue(RowerData.class);
//String str="123";

             //00   TextView as = (TextView) findViewById(R.id.as1);
             //00       as.setText(String.valueOf(str+ "RX"));
             ////////////   TextView distance1 = (TextView) findViewById(R.id.as2);
/////////                distance1.setText(String.valueOf(sp+ "RX"));
...
/////////------------------------------------------------
    ...
    private void submitPost() {
        //final String staff_Name = mMessageDatabaseReference.getText().toString();
    ...
    //88   mMessageDatabaseReference.child("strokeRate").addListenerForSingleValueEvent(
/// the problem now : he does not see the child
               //88 new ValueEventListener() {
        ...
        mMessageDatabaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                     /*   if (dataSnapshot.hasChildren())
                        {
                            TextView kh = (TextView) findViewById(R.id.as1);
                            kh.setText("has child");
                        }
                        else
                        {
                            TextView kh = (TextView) findViewById(R.id.as1);
                     ...
                     //7777  Iterable<DataSnapshot> string2= dataSnapshot.child("strokeRate").getChildren();
                         //99 String string1 = String.valueOf(dataSnapshot.child("username").getValue());
                        ...
                        TextView kh1 = (TextView) findViewById(R.id.as1);
                          kh1.setText((string1+ " st :)"));
                             ...
                             //99 String string2 = String.valueOf(dataSnapshot.child("strokeRate").getValue());

                              //99TextView kh = (TextView) findViewById(R.id.as2);
                              //99kh.setText((string2+ " SR :)"));

                         // String string2 = String.valueOf(dataSnapshot.getChildrenCount());//hild().getValue());

                            // String RX = strokeRate.getValue(String.class);
                        // RowerData rower  = dataSnapshot.getValue(RowerData.class);
                            //double str = rower.getValue();
                         // String string2 = String.valueOf(rower.getStrokeRate());



                         //77  RowerData rower=dataSnapshot.getValue(RowerData.class); // object
                        //   String string2 = String.valueOf(rower.getStrokeRate());
                         //  TextView kh = (TextView) findViewById(R.id.as2);
                          //  kh.setText((string2+ " SR :)"));
        ...
        mMessageDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    String RX = dataSnapshot.getValue(String.class);

                    distance = (TextView) findViewById(R.id.as1);
                    distance.setText(String.valueOf(RX + "RX"));
             }
...
*/
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        for (DataSnapshot StrokeRate : dataSnapshot.getChildren()) {
            ...
            distance = (TextView) findViewById(R.id.as);
            distance.setText(String.valueOf(RX + "RX"));
...
/*
    ...
    public void onDataChange(DataSnapshot dataSnapshot){
        ...
        if(dataSnapshot.getValue(String.class)!=null)
        {
            ...
            {//do that
                TextView strokeCount1 = (TextView) findViewById(R.id.as);
                strokeCount1.setText(String.valueOf("i am in server"));
            }
            else
            {
                TextView strokeCount1 = (TextView) findViewById(R.id.as);
                strokeCount1.setText(String.valueOf("i am  NOT in server"));
            }
        }
...
/*
    private void addValueEventListener( ValueEventListener() {
        @Override
...
/*
    private void  attatchDatabaseReadListener() {
      // if (mChildEventListener == null) {//read listener is detached
            mChildEventListener = new ChildEventListener()
            {
                @Override
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    //dataSnapshot contain the data stored in the firebase database
                    String RX= (String) dataSnapshot.getValue();//pass this (FriendlyMessage.class)
                     // to get data as  FriendlyMessage and this is possible as it stored in the same way at database
  ...
  /*  private void  DttatchDatabaseReadListener()
